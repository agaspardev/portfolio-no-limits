...
export const copy = {
  es: {
    hero: {
      ...
      ctaPrimary: "Abrir CV Profesional",
      ctaSecondary: "Ver trayectoria técnica",
      scroll: "Scroll",
      aria: {
        ctaPrimary: "Abrir CV profesional en nueva pestaña",
        ctaSecondary: "Ver trayectoria técnica",
  ...
  en: {
      ...
      ctaPrimary: "View Professional Resume",
      ctaSecondary: "View technical journey",
      scroll: "Scroll",
        aria: {
          ctaPrimary: "Open professional resume in a new tab",
          ctaSecondary: "View technical journey",
